...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Anthony, tu seras Capi-Premium`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Anthony, tu seras Capi-Premium`
